                ...
                <div className="mx-auto sm:px-6 lg:px-8 ">
                    <div className="p-6 overflow-hidden shadow-sm sm:rounded-lg bg-gray-200 dark:bg-gray-800 space-y-4">
                        <div className='flex justify-between'>
                            {canCreate && (
                               <Link href={route("employee-scheduler.create")} className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5'>Tambah</Link>
                            )}
                                        ...
                                        {data.map(employee => (
                                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={employee.id}>
                                                ...
                                                <td className="py-4 px-6 flex justify-end">
                                                    ...
                                                    >
                                                        {canUpdate && (
                                                            <Dropdown.Item onClick={() => toggleFormModal(employee)}>
                                                        ...
                                                        {canDelete && (
                                                            <Dropdown.Item onClick={() => handleDeleteClick(employee)}>
                                                                <div className='flex space-x-1 items-center'>
                                                                    <HiTrash/> 
                                                                    <div>Hapus</div>
                                                                </div>
