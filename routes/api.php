...
use App\Http\Controllers\Api\SettingPoinController;
...
Route::group(['prefix' => 'v1', 'middleware' => ['api', 'jwt.verify']], function () {
    ...
    Route::get('history-attendace', [AttendanceController::class, 'GetHistoryAttendace']);
    Route::post('leaves',  [LeavesController::class, 'store']);
    Route::get('schedule', [EmployeeScheduleController::class, 'index']);
    Route::get('settingpoint', [SettingPoinController::class, 'index']);
});
